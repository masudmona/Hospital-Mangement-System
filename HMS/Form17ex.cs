...
namespace HMS
{
    public partial class Form17ex : Form
    {
        ...
        private void Form17ex_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'hMSDataSetNew.Prescription' table. You can move, or remove it, as needed.
            this.prescriptionTableAdapter.Fill(this.hMSDataSetNew.Prescription);
            display_data();
            prescriptionDataGridView.ColumnHeadersDefaultCellStyle.Font = new Font("Microsoft Sans Serif", 14, FontStyle.Bold);
            prescriptionDataGridView.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.TopCenter;
            prescriptionDataGridView.RowsDefaultCellStyle.BackColor = Color.FromArgb(109, 250, 140);
            prescriptionDataGridView.DefaultCellStyle.Font = new Font("Microsoft Sans Serif", 11, FontStyle.Regular);
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Are you sure want to delete this record?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    prescriptionDataGridView.Rows.RemoveAt(prescriptionDataGridView.CurrentRow.Index);
                    sda.Update(dt);
        ...
        public void display_data() //update concurrently
        {
            ...
            sda = new SqlDataAdapter(@"select * from Prescription", conString); //sda=cmd
            dt = new DataTable();
            sda.Fill(dt);
