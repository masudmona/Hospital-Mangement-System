...
namespace HMS
{
    public partial class Form14_department : Form
    {
        public Form14_department()
        {
            InitializeComponent();
        }
        ...
        private void Form14_department_Load(object sender, EventArgs e)
        {
            ...
            display_data();
            departmentDataGridView.ColumnHeadersDefaultCellStyle.Font = new Font("Microsoft Sans Serif", 14, FontStyle.Bold);
            departmentDataGridView.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.TopCenter;
            departmentDataGridView.RowsDefaultCellStyle.BackColor = Color.FromArgb(229, 208, 177);
            departmentDataGridView.DefaultCellStyle.Font = new Font("Microsoft Sans Serif", 11, FontStyle.Regular);
        }
        ...
        {
            string query = @"INSERT INTO Department (Dept_name, Room_no)
                            VALUES('" + text_name.Text + "','" + text_room.Text + "') ";
            try
            {
                conString.Open();
        ...
        {
            sda = new SqlDataAdapter(@"select * from Department", conString); //sda=cmd
            dt = new DataTable();
            sda.Fill(dt);
        ...
        private void textBox_search_TextChanged(object sender, EventArgs e)
        {
            ...
            sda.Fill(dt);
            departmentDataGridView.DataSource = dt;
            departmentDataGridView.RowsDefaultCellStyle.BackColor = Color.Orange;
        }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    scb = new SqlCommandBuilder(sda);
                   departmentDataGridView.Rows.RemoveAt(departmentDataGridView.CurrentRow.Index);
                    sda.Update(dt);
